...
<div class="space-y-6">
    ...
    @include('visits._panel', ['visitor' => $visitor, 'visits' => $visits])
    ...
    @include('purchases._panel', ['visitor' => $visitor, 'purchases' => $purchases])

    @include('expenses._panel', ['visitor' => $visitor, 'expenses' => $expenses])
